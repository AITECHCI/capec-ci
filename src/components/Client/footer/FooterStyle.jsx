...
const Footer = ({ shape, shapeClass, logo, formStyle }) => {
    return (
        <>
                        ...
                        <div className="row">
                            ...
                            <div className="col-lg-2 col-md-6 footer-item">
                                <div className="f-item link">
                                    ...
                                    <ul>
                                        <li><Link href="/about-us">Compnay Profile</Link></li>
                                        <li><Link href="/contact-us">Help Center</Link></li>
                                        <li><Link href="/about-us">Career</Link></li>
                            ...
                            <div className="col-lg-2 col-md-6 footer-item">
                                <div className="f-item link">
                                    ...
                                    <ul>
                                        <li><Link href="/services-details/1">Manage investment</Link></li>
                                        <li><Link href="/services-details/1">Business planning</Link></li>
                                        <li><Link href="/services-details/1">Financial advices</Link></li>
                                        <li><Link href="/services-details/1">Tax strategy</Link></li>
                                        <li><Link href="/services-details/1">Insurance strategy</Link></li>
                                    </ul>
                                </div>
                            </div>
                            <div className="col-lg-4 col-md-6 footer-item">
                                <h4 className="widget-title">Newsletter</h4>
                                <p>Join our subscribers list to get the latest <br /> news and special offers.</p>
                    ...
                    <div className="container">
                        <div className="row">
                            <div className="col-lg-6">
                                <p>&copy; Copyright {(new Date().getFullYear())}. All Rights Reserved by <a href="https://themeforest.net/user/validthemes/portfolio" target='_blank'>CAPEC-CI</a></p>
                            </div>
